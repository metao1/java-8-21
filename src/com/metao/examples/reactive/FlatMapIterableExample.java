...
import com.metao.examples.reactive.DataBuffer;
import com.metao.examples.reactive.DataBufferProcessor;
import com.metao.examples.reactive.Message;
...
public class FlatMapIterableExample {
    ...
    private static class MessageToStringTransformer implements Function<Flux<Message>, Publisher<String>> {
        ...
        public Publisher<String> apply(Flux<Message> messages) {
            return transformToString(messages.blockFirst());
        }
    }
