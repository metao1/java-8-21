...
public class AdjacencyListGraph implements Graph {
	 ...
	 */
	public class EdgeIterator implements Iterator<Vertex> {
		/**
	...
	public AdjacencyListGraph useSameVertices() {
		...
		for (AdjListInfo adjListInfo : adj) newGraph.addVertex(adjListInfo.thisVertex);
	...
	public String toString() {
		...
		while (vertexIter.hasNext()) {
			...
			Iterator<Vertex> edgeIter = edgeIterator(u);
			while (edgeIter.hasNext()) {
				Vertex v = (Vertex) edgeIter.next();
